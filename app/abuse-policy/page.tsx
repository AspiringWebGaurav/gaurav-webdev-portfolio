 ...
 * 
 * Read-only policy page accessible WITHOUT authentication.
 * Used by banned users to read the abuse policy.
 */

import { useState } from 'react';
import Logo from '@/components/Logo';
import { ShieldAlert, AlertTriangle, Clock, CheckCircle, FileText, ArrowLeft } from 'lucide-react';
import Link from 'next/link';
import ContactFormModal from '@/components/ContactFormModal';

export default function AbusePolicyPublicPage() {
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-6">
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong className="text-white">No Permanent Bans:</strong> This policy only applies temporary restrictions. There are no permanent bans from failed login attempts.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">✓</span>

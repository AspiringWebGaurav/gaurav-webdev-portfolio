...
export const SEED_HERO: HeroDocument = {
  ...
  description: "Hi! I'm Gaurav Patil, a Full Stack Developer & Software Engineer based in India specializing in scalable web applications.",
...
export const SEED_PROJECTS: ProjectDocument[] = [
  {
    ...
    description: "Explore the wonders of our solar system with this captivating 3D simulation of the planets using Three.js and React.",
    coverImageStoragePath: "/p1.webp",
    coverImage: "/p1.webp",
  ...
  },
  {
    ...
    description: "Enterprise-grade video conferencing application built with Next.js 15, Stream API, and Clerk authentication.",
    coverImageStoragePath: "/p2.webp",
    coverImage: "/p2.webp",
  ...
  },
  {
    ...
    description: "Production-ready Software-as-a-Service application featuring AI image transformations, credits system, and Stripe billing.",
    coverImageStoragePath: "/p3.webp",
    coverImage: "/p3.webp",
  ...
  },
  {
    ...
    description: "High-performance recreation of the Apple iPhone 15 Pro product showcase combining GSAP timeline animations and Three.js 3D models.",
    coverImageStoragePath: "/p4.webp",
    coverImage: "/p4.webp",
...
export const SEED_TESTIMONIALS: TestimonialDocument[] = [
  {
    id: "test_01",
    order: 1,
    quote: "Collaborating with Gaurav was an exceptional experience. His code quality, modular architecture, and proactive communication made our open-source initiative a huge success.",
    name: "Alex Rivera",
    role: "Full-Stack Collaborator & Peer",
  ...
  },
  {
    id: "test_02",
    order: 2,
    quote: "Gaurav has an impressive grasp of modern React and Next.js. His performance optimizations and systematic refactoring significantly improved responsiveness across our shared projects.",
    name: "Marcus Chen",
    role: "Frontend Engineer & Contributor",
    company: "Tech Collaborators",
    avatarStoragePath: "/profile.webp",
    avatarUrl: "/profile.webp",
    isPublished: true,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    id: "test_03",
    order: 3,
    quote: "Working together on full-stack architecture and real-time data pipelines, Gaurav consistently delivered clean, defensive, and well-documented solutions on schedule.",
    name: "Priya Sharma",
    role: "Software Architect & Peer",
  ...
  },
  {
    id: "test_04",
    order: 4,
    quote: "Gaurav's attention to detail in UX responsiveness, state management, and semantic accessibility is outstanding. Highly recommended as a talented engineering partner.",
    name: "David Miller",
...
export const SEED_EXPERIENCE: ExperienceDocument[] = [
  ...
  },
  {
    ...
    description: "Designed and developed mobile applications for iOS & Android platforms using React Native.",
    company: "Software Contracting",
    period: "2024",
